...
expedition = fabricaford.fabricar(
    modelo="expedition", tipo="camioneta", controlelec=True, ac=True, añofab="2019"
)
...
class TiendaMascota:
    ...
    def remover_mascota(self, mascota):
        ...
        for mascota_reg in self.mascotas:
            if (
                mascota.namem == mascota_reg.namem
                and mascota_reg.especie == mascota.especie
                and mascota.color == mascota_reg.color
            ):
                continue
            else:
    ...
    def nuevocliente(self, nombrenuevo, numeronuevo):
        nc = PetCliente(name=nombrenuevo, num=numeronuevo)
    ...
    def nuevamascota(self, nraza, ncolor, ndueño, nnamem, nespecie):
        nm = Mascota(
            raza=nraza, color=ncolor, dueño=ndueño, namem=nnamem, especie=nespecie
        )
